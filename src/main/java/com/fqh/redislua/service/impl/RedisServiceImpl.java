package com.fqh.redislua.service.impl;
...
public class RedisServiceImpl implements RedisService {
    ...
    public Object addsLuaBloomFilter(String filterName, List<String> values) {
        ...
        bloomAdd.setScriptSource(new ResourceScriptSource(new ClassPathResource("/lua/bloomFilter-inster.lua")));
    ...
    public Boolean existsLuabloomFilter(String filterName, String value) {
        ...
        bloomExists.setScriptSource(new ResourceScriptSource(new ClassPathResource("/lua/bloomFilter-exist.lua")));
